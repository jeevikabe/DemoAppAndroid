...
public class APIServer {
   ...
   private final LocalStorage localStorage;
    ...
    private static final String TAG = com.example.demoapp.network.APIServer.class.getSimpleName();
...
//        /*=============Don't Forget to initialize Auth Headers Here and use same in AndroidNetworking.addHeaders(yourHeader)*/
        ...
        String credentials = localStorage.get(LocalStorage.APP_AUTH_USER_NAME) + ":" + localStorage.get(LocalStorage.APP_AUTH_PASSWORD);
    ...
    public void postJSON1(final String url, JSONObject jsonObject, final APIResponseListener apiResponseListener) {
        apiResponse = null;
        apiStatusCode = 0;
        this.apiResponseListener = apiResponseListener;
        AndroidNetworking.post(url).addJSONObjectBody(jsonObject).setTag(context).setPriority(Priority.HIGH).build().setAnalyticsListener(new AnalyticsListener() {
                    @Override
                ...
                .getAsOkHttpResponseAndJSONObject(new OkHttpResponseAndJSONObjectRequestListener() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        if ((anError != null) && (anError.getResponse() != null)) {
                            Log.d("nk", "onError " + anError.getErrorCode() + " for " + url);
...
//        }
    ...
    public void uploadImage(final String url, String imageFilePath, String filetype, final APIResponseListener responseListener, final UploadFileAndResponseListener uploadFileAndResponseListener) {
        ...
        AndroidNetworking.upload(url)
                ...
                .addMultipartFile(filetype, new File(imageFilePath))
                .setTag(this)
                .build()
                .setAnalyticsListener(new AnalyticsListener() {
                ...
                .getAsOkHttpResponseAndJSONObject(new OkHttpResponseAndJSONObjectRequestListener() {
                    ...
                    public void onError(ANError error) {
                        if (error != null) {
                            ...
                            Log.d(TAG, "onError errorCode : " + error.getErrorCode() + " for " + url);
                            Log.d(TAG, "onError errorBody : " + error.getErrorBody());
                            Log.d(TAG, "onError errorDetail : " + error.getErrorDetail());
                            final long finalTempTotalBytes = totalBytes;
                            final long finalTempBytesUploaded = bytesUploaded;
                            apiResponse = error.getErrorBody().toString();
                            apiStatusCode = error.getErrorCode();
                            if (apiResponseListener != null) {
                                handleResponse(apiStatusCode, apiResponse);
                            }
                            ...
                            final long finalTempTotalBytes = totalBytes;
                            final long finalTempBytesUploaded = bytesUploaded;
                            apiResponse = error.getErrorDetail().toString();
                            apiStatusCode = error.getErrorCode();
                            if (apiResponseListener != null) {
                                handleResponse(apiStatusCode, apiResponse);
                            }
